...
const verticalVisible = {
    ...
    type: 'switch',
    label: '布局(行/列, 仅设计时)',
    config: { help: '仅用于设计时，排版易看，无参数意义', size: 'small', checkedChildren: '行布局', unCheckedChildren: '列布局' },
    class: 'design-config'
}
const dataName = {
    prop: 'dataName',
...
export const formMore = [
    ...
    { type: 'switch', prop: 'config.labelWrap', label: 'label自动换行(labelWrap)' },
    wrapperCol,
    {
        prop: 'config.layout',
        label: 'layout(表单布局)',
...
const getDocLink = (name) => {
    return `https://light2f.com/#/doc/freedomen/${name}`
}
                    ...
                    more: [
                        {
                            ...
                            type: 'input',
                            label: '背景色',
                            placeholder: '如：success、red、#ccc、rgb(0,0,0)'
                        }
                    ],
                    style
                }
